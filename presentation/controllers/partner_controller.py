...
class PartnerController(BaseController):
    ...
    def list_all(self) -> list[Partner]:
        return self._partner_repo.list_all()

    def list_customers(self) -> list[Partner]:
        return self._partner_repo.list_by_type(PartnerType.CUSTOMER)

    def list_vendors(self) -> list[Partner]:
        return self._partner_repo.list_by_type(PartnerType.VENDOR)
